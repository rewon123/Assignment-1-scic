          ...
          <Tilt options={{ max: 25 }}>
            <Card>
              <Card.Header as="h5" className="d-flex justify-content-center flex-wrap">
                Rizwan rashid Experience
              </Card.Header>
              <Card.Body className="d-flex justify-content-center flex-column">
                <div>
                  <Card.Title className="text-center">Front-end and MERN developer (ready to get hired)</Card.Title>
                </div>
                <div>
                  <Card.Text className="text-center style">
                    <strong className="body-title-style ">Full Stack Developer</strong>
                    <br />
                    <strong>Technology:</strong> React js,Node js,Mongodb,Express js,Javascript,Bootstrap 5,Tailwind css,Material ui,Html, css,Sass / Scss
                    <br />
                    <br />
                    <strong>Tools:</strong>Vs code ,Git ,Figma ,Heroku ,Netlify ,
                    <br />
                    ...
                    <ul className="text-left">
                      ...
                      <li><strong>Developed</strong> automation system to create Mongodb data management system that
